...
function tema_teste_dev_scripts() { 
	...
	wp_enqueue_script( 'tema-teste-dev-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'tema-teste-dev-popper', 'https://unpkg.com/@popperjs/core@2', array(), _S_VERSION, true );

	wp_enqueue_script( 'tema-teste-dev-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), _S_VERSION, true );
